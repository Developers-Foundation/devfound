        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-10 col-md-8">
                    <h1>Careers</h1>
                    <p class="lead">
                        Grow your skillset and become a member of our evergrowing global family.
                    </p>
                </div>
            </div>
            <!--end of row-->
    ...
    <section class="switchable bg--secondary">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 switchable__text text-center">
                    <div class="video-cover border--round">
                        <div class="background-image-holder">
                            <img alt="image" src="img/education-5.jpg" />
                        </div>
                        <div class="video-play-icon"></div>
                        <iframe src="https://www.youtube.com/embed/6p45ooZOOPo?autoplay=1" allowfullscreen="allowfullscreen"></iframe>
                    </div>
                    <!--end video cover-->
                    <span>Check out the working culture at Stack</span>
                </div>
            </div>
            <!--end of row-->
        </div>
