            ...
            <div class="col-md-11 col-sm-12 text-right text-left-xs text-left-sm">
                <div class="bar__module">
                    <ul class="menu-horizontal text-left">
                        <li class="dropdown">
                            <span class="dropdown__trigger">Organizations</span>
                            <div class="dropdown__container" style="left: -321.484px;">
                                <div class="container">
                                    <div class="row">
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -389.844px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content col-md-2" style="left: 389.844px;">
                                            <ul class="menu-vertical">
                                                <li class="dropdown">
                                                    <span class="dropdown__trigger">About</span>
                                                    <div class="dropdown__container" style="left: -415.84px;">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="dropdown__content col-md-2" style="left: 415.84px;">
                                                                    <ul class="menu-vertical">
                                                                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -459.785px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content col-md-2 col-sm-6" style="left: 459.785px;">
                                            <ul class="menu-vertical">
                                                <li class="dropdown">
                                                    <span class="dropdown__trigger">Articles</span>
                                                    <div class="dropdown__container" style="left: -485.781px;">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="dropdown__content col-md-2" style="left: 485.781px;">
                                                                    <ul class="menu-vertical">
                                                                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -524.492px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content col-md-2" style="left: 524.492px;">
                                            <ul class="menu-vertical">
                                                <li class="dropdown">
                                                    <span class="dropdown__trigger">Shop Standard</span>
                                                    <div class="dropdown__container" style="left: -550.488px;">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="dropdown__content col-md-2" style="left: 550.488px;">
                                                                    <ul class="menu-vertical">
                                                                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -589.062px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content col-md-2" style="left: 589.062px;">
                                            <ul class="menu-vertical">
                                                <li class="dropdown">
                                                    <span class="dropdown__trigger">Titles Outside</span>
                                                    <div class="dropdown__container" style="left: -615.059px;">
                                                        <div class="container">
                                                            <div class="row">
                                                                <div class="dropdown__content col-md-2" style="left: 615.059px;">
                                                                    <ul class="menu-vertical">
                                                                        <li>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -690.43px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content dropdown__content--lg col-md-8" style="left: 390.02px;">
                                                ...
                                                <div class="container pos-vertical-center">
                                                    <div class="row">
                                                        <div class="col-md-10 col-md-offset-1">
                                                            <img alt="Logo" src="img/logo-light.png" class="image--xxs">
                                                            <span class="h3 color--white">Over 260 modular interface blocks.</span>
                                                            <a href="#" class="btn btn--primary type--uppercase">
                                                                            <span class="btn__text">
                                                                                Launch Builder
                                                                            </span>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown__container" style="left: -769.297px;">
                                <div class="container">
                                    <div class="row">
                                        <div class="dropdown__content dropdown__content--lg col-md-8" style="left: 390.02px;">
